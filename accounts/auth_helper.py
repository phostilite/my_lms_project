...
stream = open('/Users/apple/Documents/my_lms_project/accounts/oauth_settings.yaml', 'r')
...
def store_user(request, user_info):
    try:
...
def extract_user_details(result):
  user_details = {}
