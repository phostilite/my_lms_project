...
SECRET_KEY = 'django-insecure-8ex+p6(xq8#!*-ei^!@mln^8o9*b#yiy40#4g2kp*vcx=lnpe^'
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.getenv('GOOGLE_CLIENT_ID_1')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.getenv('GOOGLE_CLIENT_SECRET_1')
